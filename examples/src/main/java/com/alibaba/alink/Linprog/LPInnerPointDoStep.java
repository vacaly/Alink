...
public class LPInnerPointDoStep extends ComputeFunction {
    ...
    public void calc(ComContext context) {
        ...
        Tuple5<DenseVector, DenseVector, DenseVector, Double, Double> data = LinProUtils.doStep
                (x, d_x, y, d_y, z, d_z, tau, d_tau, kappa, d_kappa, alpha);
        context.putObj(LPInnerPointBatchOp.LOCAL_X, LinProUtils.Vector2List(data.f0));
        context.putObj(LPInnerPointBatchOp.LOCAL_Y, LinProUtils.Vector2List(data.f1));
        context.putObj(LPInnerPointBatchOp.LOCAL_Z, LinProUtils.Vector2List(data.f2));
    ...
    static public boolean indicators(DenseVector x, DenseVector y, DenseVector z,
        ...
        DenseMatrix A = context.getObj(LPInnerPointBatchOp.STATIC_A);
